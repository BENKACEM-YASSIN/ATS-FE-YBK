import { Component, EventEmitter, Output, inject, NgZone, ChangeDetectorRef, OnInit, OnDestroy } from '@angular/core';
...
export class WelcomeScreenComponent implements OnInit, OnDestroy {
    ...
    @Output() importData = new EventEmitter<{ data: CVData, jobDescription?: string, atsResult?: ATSResult }>();
    ...
    // Handle PDF file selection from template event
    ...
    // Handle JSON file selection from template event
    ...
    async processPdfFile(file: File) {
        ...
        try {
            ...
            this.ngZone.run(() => {
                ...
                this.screenState = 'input_jd'; // Skip review step
